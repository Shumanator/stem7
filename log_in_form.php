        ...
        <div class="row">
            <div class="col-12 bg-light text-black">
                ...
                <form action="login.php" method="post" class="was-validated">
                    <div class="mb-3 mt-3">
                        <label for="college_id" class="form-label">ID:</label>
                        <input type="text" class="form-control" id="college_id" placeholder="Enter Your College ID" name="college_id" required>
